...
def register_face_check():
    ...
    # TEMPORAL: saltar verificación facial y crear cuenta directo
    ...
    log_action(user_id, "user_registered", "Registro completado temporalmente sin verificación facial")
